...
const (
	Column_number   Column_Type = 0
	Column_string   Column_Type = 1
	Column_datetime Column_Type = 2
)
...
type SchemaResponse struct {
	...
	Columns       map[string]*ColumnList `protobuf:"bytes,3,rep,name=columns,proto3" json:"columns,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	ColumnValues  map[string]*StringList `protobuf:"bytes,4,rep,name=columnValues,proto3" json:"columnValues,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type Schema struct {
	...
	Functions      *StringList             `protobuf:"bytes,2,opt,name=functions,proto3" json:"functions,omitempty"`
	SubTableValues map[string]*SubTableMap `protobuf:"bytes,4,rep,name=subTableValues,proto3" json:"subTableValues,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *Schema) GetFunctions() *StringList {
	if x != nil {
		return x.Functions
	}
	return nil
...
func (x *Schema) GetSubTableValues() map[string]*SubTableMap {
	if x != nil {
		return x.SubTableValues
	}
	return nil
}
...
type Table struct {
	...
	SubTables     []*SubTable            `protobuf:"bytes,2,rep,name=subTables,proto3" json:"subTables,omitempty"`
...
func (x *Table) GetSubTables() []*SubTable {
	if x != nil {
		return x.SubTables
	}
	return nil
...
type SubTable struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Name          string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	DependsOn     *StringList            `protobuf:"bytes,2,opt,name=dependsOn,proto3" json:"dependsOn,omitempty"`
...
func (x *SubTable) GetDependsOn() *StringList {
	if x != nil {
		return x.DependsOn
	}
	return nil
...
func (x *SubTableMap) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type Column struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Name          string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	Type          Column_Type            `protobuf:"varint,2,opt,name=type,proto3,enum=pluginv2.Column_Type" json:"type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_backend_proto_rawDesc = "" +
	...
	"\x11ColumnValuesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12*\n" +
	"\x05value\x18\x02 \x01(\v2\x14.pluginv2.StringListR\x05value:\x028\x01\"\x8d\x02\n" +
	"\x06Schema\x12'\n" +
	"\x06tables\x18\x01 \x03(\v2\x0f.pluginv2.TableR\x06tables\x122\n" +
	"\tfunctions\x18\x02 \x01(\v2\x14.pluginv2.StringListR\tfunctions\x12L\n" +
	"\x0esubTableValues\x18\x04 \x03(\v2$.pluginv2.Schema.SubTableValuesEntryR\x0esubTableValues\x1aX\n" +
	"\x13SubTableValuesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12+\n" +
	"\x05value\x18\x02 \x01(\v2\x15.pluginv2.SubTableMapR\x05value:\x028\x01\"y\n" +
	"\x05Table\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x120\n" +
	"\tsubTables\x18\x02 \x03(\v2\x12.pluginv2.SubTableR\tsubTables\x12*\n" +
	"\acolumns\x18\x03 \x03(\v2\x10.pluginv2.ColumnR\acolumns\"f\n" +
	"\bSubTable\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x122\n" +
	"\tdependsOn\x18\x02 \x01(\v2\x14.pluginv2.StringListR\tdependsOn\x12\x12\n" +
	"\x04root\x18\x03 \x01(\bR\x04root\"6\n" +
	"\n" +
	"ColumnList\x12(\n" +
	"\x06values\x18\x01 \x03(\v2\x10.pluginv2.ColumnR\x06values\"\x99\x01\n" +
	"\vSubTableMap\x129\n" +
	"\x06values\x18\x01 \x03(\v2!.pluginv2.SubTableMap.ValuesEntryR\x06values\x1aO\n" +
	"\vValuesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12*\n" +
	"\x05value\x18\x02 \x01(\v2\x14.pluginv2.StringListR\x05value:\x028\x01\"u\n" +
	"\x06Column\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12)\n" +
	"\x04type\x18\x02 \x01(\x0e2\x15.pluginv2.Column.TypeR\x04type\",\n" +
	"\x04Type\x12\n" +
	"\n" +
...
var file_backend_proto_goTypes = []any{
	...
	(Column_Type)(0),                       // 4: pluginv2.Column.Type
