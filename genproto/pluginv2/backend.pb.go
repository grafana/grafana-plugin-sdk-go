...
// ResourceFullIdentifier fully identifies the resource a custom route is attached to.
...
type ResourceFullIdentifier struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	...
	Plural        string                 `protobuf:"bytes,6,opt,name=plural,proto3" json:"plural,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ResourceFullIdentifier) Reset() {
	*x = ResourceFullIdentifier{}
	mi := &file_backend_proto_msgTypes[33]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ResourceFullIdentifier) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ResourceFullIdentifier) ProtoMessage() {}

func (x *ResourceFullIdentifier) ProtoReflect() protoreflect.Message {
	mi := &file_backend_proto_msgTypes[33]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ResourceFullIdentifier.ProtoReflect.Descriptor instead.
func (*ResourceFullIdentifier) Descriptor() ([]byte, []int) {
	return file_backend_proto_rawDescGZIP(), []int{33}
}

func (x *ResourceFullIdentifier) GetNamespace() string {
	if x != nil {
		return x.Namespace
	}
	return ""
...
func (x *ResourceFullIdentifier) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *ResourceFullIdentifier) GetGroup() string {
	if x != nil {
		return x.Group
	}
	return ""
...
func (x *ResourceFullIdentifier) GetVersion() string {
	if x != nil {
		return x.Version
	}
	return ""
...
func (x *ResourceFullIdentifier) GetKind() string {
	if x != nil {
		return x.Kind
	}
	return ""
...
func (x *ResourceFullIdentifier) GetPlural() string {
	if x != nil {
		return x.Plural
	}
	return ""
...
// CallCustomRouteRequest is a request to a custom route or kind subresource.
type CallCustomRouteRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// NOTE: this may not include app or datasource instance settings depending on the request
	PluginContext *PluginContext `protobuf:"bytes,1,opt,name=pluginContext,proto3" json:"pluginContext,omitempty"`
	// Identifier fully identifies the resource the route is attached to.
	Identifier *ResourceFullIdentifier `protobuf:"bytes,2,opt,name=identifier,proto3" json:"identifier,omitempty"`
	// Path is the path past the identifier information. For a subresource route this is
	// the subresource (e.g. `bar` in `foos/foo/bar`); for a non-subresource route it is
	// the path section past the namespace (or version, if the route is not namespaced).
	Path string `protobuf:"bytes,3,opt,name=path,proto3" json:"path,omitempty"`
	// Method is the forwarded HTTP method for the request.
	Method string `protobuf:"bytes,4,opt,name=method,proto3" json:"method,omitempty"`
	// URL is the full forwarded HTTP URL (useful for query parameters, host/protocol for redirects).
	Url string `protobuf:"bytes,5,opt,name=url,proto3" json:"url,omitempty"`
	// Headers are the forwarded HTTP headers for the request, if any.
	Headers map[string]*StringList `protobuf:"bytes,6,rep,name=headers,proto3" json:"headers,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// Body is the forwarded HTTP body for the request, if any.
	Body          []byte `protobuf:"bytes,7,opt,name=body,proto3" json:"body,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *CallCustomRouteRequest) Reset() {
	*x = CallCustomRouteRequest{}
	mi := &file_backend_proto_msgTypes[34]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CallCustomRouteRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CallCustomRouteRequest) ProtoMessage() {}

func (x *CallCustomRouteRequest) ProtoReflect() protoreflect.Message {
	mi := &file_backend_proto_msgTypes[34]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CallCustomRouteRequest.ProtoReflect.Descriptor instead.
func (*CallCustomRouteRequest) Descriptor() ([]byte, []int) {
	return file_backend_proto_rawDescGZIP(), []int{34}
}

func (x *CallCustomRouteRequest) GetPluginContext() *PluginContext {
	if x != nil {
		return x.PluginContext
	}
	return nil
...
func (x *CallCustomRouteRequest) GetIdentifier() *ResourceFullIdentifier {
	if x != nil {
		return x.Identifier
	}
	return nil
...
func (x *CallCustomRouteRequest) GetPath() string {
	if x != nil {
		return x.Path
	}
	return ""
...
func (x *CallCustomRouteRequest) GetMethod() string {
	if x != nil {
		return x.Method
	}
	return ""
...
func (x *CallCustomRouteRequest) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
func (x *CallCustomRouteRequest) GetHeaders() map[string]*StringList {
	if x != nil {
		return x.Headers
	}
	return nil
...
func (x *CallCustomRouteRequest) GetBody() []byte {
	if x != nil {
		return x.Body
	}
	return nil
...
// CallCustomRouteResponse is a (streamed) response from a custom route call.
...
func (x *CallCustomRouteResponse) Reset() {
	*x = CallCustomRouteResponse{}
	mi := &file_backend_proto_msgTypes[35]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CallCustomRouteResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CallCustomRouteResponse) ProtoMessage() {}

func (x *CallCustomRouteResponse) ProtoReflect() protoreflect.Message {
	mi := &file_backend_proto_msgTypes[35]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CallCustomRouteResponse.ProtoReflect.Descriptor instead.
func (*CallCustomRouteResponse) Descriptor() ([]byte, []int) {
	return file_backend_proto_rawDescGZIP(), []int{35}
}

func (x *CallCustomRouteResponse) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *CallCustomRouteResponse) GetHeaders() map[string]*StringList {
	if x != nil {
		return x.Headers
	}
	return nil
...
func (x *CallCustomRouteResponse) GetBody() []byte {
	if x != nil {
		return x.Body
	}
	return nil
...
var file_backend_proto_rawDesc = string([]byte{
	...
	0x65, 0x63, 0x74, 0x73, 0x22, 0x6c, 0x0a, 0x0c, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x65,
	...
	0x64, 0x65, 0x22, 0xa6, 0x01, 0x0a, 0x16, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x46,
	0x75, 0x6c, 0x6c, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x12, 0x1c, 0x0a,
	...
	,
	...
	0x52, 0x03, 0x75, 0x72, 0x6c, 0x12, 0x47, 0x0a, 0x07, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x73,
	0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2d, 0x2e, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x76,
	0x32, 0x2e, 0x43, 0x61, 0x6c, 0x6c, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x52, 0x6f, 0x75, 0x74,
	...
	,
	...
	0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x76, 0x32, 0x2e, 0x53,
	0x74, 0x72, 0x69, 0x6e, 0x67, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65,
	0x3a, 0x02, 0x38, 0x01, 0x2a, 0x26, 0x0a, 0x0f, 0x44, 0x61, 0x74, 0x61, 0x46, 0x72, 0x61, 0x6d,
	0x65, 0x46, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x12, 0x09, 0x0a, 0x05, 0x41, 0x52, 0x52, 0x4f, 0x57,
	0x10, 0x00, 0x12, 0x08, 0x0a, 0x04, 0x4a, 0x53, 0x4f, 0x4e, 0x10, 0x01, 0x32, 0x5b, 0x0a, 0x08,
	0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x4f, 0x0a, 0x0c, 0x43, 0x61, 0x6c, 0x6c,
	0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x1d, 0x2e, 0x70, 0x6c, 0x75, 0x67, 0x69,
	...
	,
	...
	,
})
...
var file_backend_proto_msgTypes = make([]protoimpl.MessageInfo, 51)
var file_backend_proto_goTypes = []any{
	...
	(*AppInstanceSettings)(nil),            // 5: pluginv2.AppInstanceSettings
	(*DataSourceInstanceSettings)(nil),     // 6: pluginv2.DataSourceInstanceSettings
	(*User)(nil),                           // 7: pluginv2.User
	(*PluginContext)(nil),                  // 8: pluginv2.PluginContext
	(*StringList)(nil),                     // 9: pluginv2.StringList
	(*CallResourceRequest)(nil),            // 10: pluginv2.CallResourceRequest
	(*CallResourceResponse)(nil),           // 11: pluginv2.CallResourceResponse
	(*TimeRange)(nil),                      // 12: pluginv2.TimeRange
	(*DataQuery)(nil),                      // 13: pluginv2.DataQuery
	...
	(*ResourceFullIdentifier)(nil),         // 38: pluginv2.ResourceFullIdentifier
	(*CallCustomRouteRequest)(nil),         // 39: pluginv2.CallCustomRouteRequest
	(*CallCustomRouteResponse)(nil),        // 40: pluginv2.CallCustomRouteResponse
	...
	nil,                                    // 54: pluginv2.CallCustomRouteRequest.HeadersEntry
	nil,                                    // 55: pluginv2.CallCustomRouteResponse.HeadersEntry
}
var file_backend_proto_depIdxs = []int32{
	...
	8,  // 16: pluginv2.QueryChunkedDataRequest.pluginContext:type_name -> pluginv2.PluginContext
	48, // 17: pluginv2.QueryChunkedDataRequest.headers:type_name -> pluginv2.QueryChunkedDataRequest.HeadersEntry
	13, // 18: pluginv2.QueryChunkedDataRequest.queries:type_name -> pluginv2.DataQuery
	...
	8,  // 21: pluginv2.CollectMetricsRequest.pluginContext:type_name -> pluginv2.PluginContext
	49, // 22: pluginv2.CollectMetricsResponse.metrics:type_name -> pluginv2.CollectMetricsResponse.Payload
	8,  // 23: pluginv2.CheckHealthRequest.pluginContext:type_name -> pluginv2.PluginContext
	...
	8,  // 26: pluginv2.SubscribeStreamRequest.pluginContext:type_name -> pluginv2.PluginContext
	...
	8,  // 29: pluginv2.PublishStreamRequest.pluginContext:type_name -> pluginv2.PluginContext
	...
	8,  // 32: pluginv2.RunStreamRequest.pluginContext:type_name -> pluginv2.PluginContext
	53, // 33: pluginv2.RunStreamRequest.headers:type_name -> pluginv2.RunStreamRequest.HeadersEntry
	8,  // 34: pluginv2.AdmissionRequest.pluginContext:type_name -> pluginv2.PluginContext
	4,  // 35: pluginv2.AdmissionRequest.operation:type_name -> pluginv2.AdmissionRequest.Operation
	29, // 36: pluginv2.AdmissionRequest.kind:type_name -> pluginv2.GroupVersionKind
	37, // 37: pluginv2.ValidationResponse.result:type_name -> pluginv2.StatusResult
	37, // 38: pluginv2.MutationResponse.result:type_name -> pluginv2.StatusResult
	8,  // 39: pluginv2.ConversionRequest.pluginContext:type_name -> pluginv2.PluginContext
	34, // 40: pluginv2.ConversionRequest.objects:type_name -> pluginv2.RawObject
	33, // 41: pluginv2.ConversionRequest.target_version:type_name -> pluginv2.GroupVersion
	37, // 42: pluginv2.ConversionResponse.result:type_name -> pluginv2.StatusResult
	34, // 43: pluginv2.ConversionResponse.objects:type_name -> pluginv2.RawObject
	8,  // 44: pluginv2.CallCustomRouteRequest.pluginContext:type_name -> pluginv2.PluginContext
	38, // 45: pluginv2.CallCustomRouteRequest.identifier:type_name -> pluginv2.ResourceFullIdentifier
	54, // 46: pluginv2.CallCustomRouteRequest.headers:type_name -> pluginv2.CallCustomRouteRequest.HeadersEntry
	55, // 47: pluginv2.CallCustomRouteResponse.headers:type_name -> pluginv2.CallCustomRouteResponse.HeadersEntry
	9,  // 48: pluginv2.CallResourceRequest.HeadersEntry.value:type_name -> pluginv2.StringList
	9,  // 49: pluginv2.CallResourceResponse.HeadersEntry.value:type_name -> pluginv2.StringList
	16, // 50: pluginv2.QueryDataResponse.ResponsesEntry.value:type_name -> pluginv2.DataResponse
	9,  // 51: pluginv2.CallCustomRouteRequest.HeadersEntry.value:type_name -> pluginv2.StringList
	9,  // 52: pluginv2.CallCustomRouteResponse.HeadersEntry.value:type_name -> pluginv2.StringList
	10, // 53: pluginv2.Resource.CallResource:input_type -> pluginv2.CallResourceRequest
	14, // 54: pluginv2.Data.QueryData:input_type -> pluginv2.QueryDataRequest
	17, // 55: pluginv2.Data.QueryChunkedData:input_type -> pluginv2.QueryChunkedDataRequest
	21, // 56: pluginv2.Diagnostics.CheckHealth:input_type -> pluginv2.CheckHealthRequest
	19, // 57: pluginv2.Diagnostics.CollectMetrics:input_type -> pluginv2.CollectMetricsRequest
	23, // 58: pluginv2.Stream.SubscribeStream:input_type -> pluginv2.SubscribeStreamRequest
	27, // 59: pluginv2.Stream.RunStream:input_type -> pluginv2.RunStreamRequest
	25, // 60: pluginv2.Stream.PublishStream:input_type -> pluginv2.PublishStreamRequest
	30, // 61: pluginv2.AdmissionControl.ValidateAdmission:input_type -> pluginv2.AdmissionRequest
	30, // 62: pluginv2.AdmissionControl.MutateAdmission:input_type -> pluginv2.AdmissionRequest
	35, // 63: pluginv2.ResourceConversion.ConvertObjects:input_type -> pluginv2.ConversionRequest
	39, // 64: pluginv2.CustomRoute.CallCustomRoute:input_type -> pluginv2.CallCustomRouteRequest
	11, // 65: pluginv2.Resource.CallResource:output_type -> pluginv2.CallResourceResponse
	15, // 66: pluginv2.Data.QueryData:output_type -> pluginv2.QueryDataResponse
	18, // 67: pluginv2.Data.QueryChunkedData:output_type -> pluginv2.QueryChunkedDataResponse
	22, // 68: pluginv2.Diagnostics.CheckHealth:output_type -> pluginv2.CheckHealthResponse
	20, // 69: pluginv2.Diagnostics.CollectMetrics:output_type -> pluginv2.CollectMetricsResponse
	24, // 70: pluginv2.Stream.SubscribeStream:output_type -> pluginv2.SubscribeStreamResponse
	28, // 71: pluginv2.Stream.RunStream:output_type -> pluginv2.StreamPacket
	26, // 72: pluginv2.Stream.PublishStream:output_type -> pluginv2.PublishStreamResponse
	31, // 73: pluginv2.AdmissionControl.ValidateAdmission:output_type -> pluginv2.ValidationResponse
	32, // 74: pluginv2.AdmissionControl.MutateAdmission:output_type -> pluginv2.MutationResponse
	36, // 75: pluginv2.ResourceConversion.ConvertObjects:output_type -> pluginv2.ConversionResponse
	40, // 76: pluginv2.CustomRoute.CallCustomRoute:output_type -> pluginv2.CallCustomRouteResponse
