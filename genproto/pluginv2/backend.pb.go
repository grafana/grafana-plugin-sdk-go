...
const file_backend_proto_rawDesc = "" +
	...
	"\x04role\x18\x04 \x01(\tR\x04role\"\xb2\x04\n" +
	...
	"\tqueryType\x18\x06 \x01(\tR\tqueryType\"\xb2\x02\n" +
	...
	"\aqueries\x18\x03 \x03(\v2\x13.pluginv2.DataQueryR\aqueries\x121\n" +
	"\x06format\x18\x04 \x01(\x0e2\x19.pluginv2.DataFrameFormatR\x06format\x1a:\n" +
	"\fHeadersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12,\n" +
	"\x05value\x18\x02 \x01(\v2\x16.pluginv2.DataResponseR\x05value:\x028\x01\"\xc5\x01\n" +
	...
	"\verrorSource\x18\x05 \x01(\tR\verrorSource\x121\n" +
	"\x06format\x18\x06 \x01(\x0e2\x19.pluginv2.DataFrameFormatR\x06format\"\xc0\x02\n" +
	...
	"\verrorSource\x18\x06 \x01(\tR\verrorSource\x121\n" +
	"\x06format\x18\a \x01(\x0e2\x19.pluginv2.DataFrameFormatR\x06format\"V\n" +
	...
	"\x0fDataFrameFormat\x12\t\n" +
	"\x05ARROW\x10\x00\x12\b\n" +
	"\x04JSON\x10\x012[\n" +
	"\bResource\x12O\n" +
