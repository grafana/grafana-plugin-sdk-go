...
type User struct {
	...
	Permissions map[string]*StringList `protobuf:"bytes,5,rep,name=permissions,proto3" json:"permissions,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *User) GetPermissions() map[string]*StringList {
	if x != nil {
...
var file_backend_proto_rawDesc = []byte{
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xf3, 0x01, 0x0a, 0x04, 0x55, 0x73,
	...
	0x52, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x12, 0x41, 0x0a, 0x0b, 0x70, 0x65, 0x72, 0x6d, 0x69, 0x73,
	0x73, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x70, 0x6c,
	0x75, 0x67, 0x69, 0x6e, 0x76, 0x32, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x2e, 0x50, 0x65, 0x72, 0x6d,
	0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x0b, 0x70, 0x65,
	0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x1a, 0x54, 0x0a, 0x10, 0x50, 0x65, 0x72,
	...
	0x9c, 0x02, 0x0a, 0x0d, 0x50, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x78,
	...
	0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x22, 0x24,
	...
	0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0x5b, 0x0a,
...
var file_backend_proto_goTypes = []interface{}{
	...
	nil,                                    // 27: pluginv2.User.PermissionsEntry
...
var file_backend_proto_depIdxs = []int32{
	...
	27, // 2: pluginv2.User.permissions:type_name -> pluginv2.User.PermissionsEntry
	5,  // 3: pluginv2.PluginContext.user:type_name -> pluginv2.User
	3,  // 4: pluginv2.PluginContext.appInstanceSettings:type_name -> pluginv2.AppInstanceSettings
	4,  // 5: pluginv2.PluginContext.dataSourceInstanceSettings:type_name -> pluginv2.DataSourceInstanceSettings
	...
	7,  // 24: pluginv2.User.PermissionsEntry.value:type_name -> pluginv2.StringList
	...
	8,  // 28: pluginv2.Resource.CallResource:input_type -> pluginv2.CallResourceRequest
	12, // 29: pluginv2.Data.QueryData:input_type -> pluginv2.QueryDataRequest
	17, // 30: pluginv2.Diagnostics.CheckHealth:input_type -> pluginv2.CheckHealthRequest
	15, // 31: pluginv2.Diagnostics.CollectMetrics:input_type -> pluginv2.CollectMetricsRequest
	19, // 32: pluginv2.Stream.SubscribeStream:input_type -> pluginv2.SubscribeStreamRequest
	23, // 33: pluginv2.Stream.RunStream:input_type -> pluginv2.RunStreamRequest
	21, // 34: pluginv2.Stream.PublishStream:input_type -> pluginv2.PublishStreamRequest
	9,  // 35: pluginv2.Resource.CallResource:output_type -> pluginv2.CallResourceResponse
	13, // 36: pluginv2.Data.QueryData:output_type -> pluginv2.QueryDataResponse
	18, // 37: pluginv2.Diagnostics.CheckHealth:output_type -> pluginv2.CheckHealthResponse
	16, // 38: pluginv2.Diagnostics.CollectMetrics:output_type -> pluginv2.CollectMetricsResponse
	20, // 39: pluginv2.Stream.SubscribeStream:output_type -> pluginv2.SubscribeStreamResponse
	24, // 40: pluginv2.Stream.RunStream:output_type -> pluginv2.StreamPacket
	22, // 41: pluginv2.Stream.PublishStream:output_type -> pluginv2.PublishStreamResponse
