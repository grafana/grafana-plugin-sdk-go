...
type SubscribeStreamRequest struct {
	...
	Path string `protobuf:"bytes,2,opt,name=path,proto3" json:"path,omitempty"`
	// optional DataQuery if the channel subscription initiated by
	// a channel in a frame in QueryData method.
	Query *DataQuery `protobuf:"bytes,3,opt,name=query,proto3" json:"query,omitempty"`
}
...
func (x *SubscribeStreamRequest) GetQuery() *DataQuery {
	if x != nil {
		return x.Query
	}
	return nil
...
func (x *RunStreamRequest) GetQuery() *DataQuery {
	if x != nil {
		return x.Query
	}
	return nil
...
var file_backend_proto_rawDesc = []byte{
	...
	0x10, 0x02, 0x22, 0x96, 0x01, 0x0a, 0x16, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65,
	...
	0x75, 0x65, 0x72, 0x79, 0x52, 0x05, 0x71, 0x75, 0x65, 0x72, 0x79, 0x22, 0xa7, 0x01, 0x0a, 0x17,
	...
	0x4e, 0x5f, 0x44, 0x45, 0x4e, 0x49, 0x45, 0x44, 0x10, 0x02, 0x22, 0x90, 0x01, 0x0a, 0x10, 0x52,
	...
	0x74, 0x68, 0x12, 0x29, 0x0a, 0x05, 0x71, 0x75, 0x65, 0x72, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x13, 0x2e, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x76, 0x32, 0x2e, 0x44, 0x61, 0x74,
	0x61, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52, 0x05, 0x71, 0x75, 0x65, 0x72, 0x79, 0x22, 0x22, 0x0a,
...
var file_backend_proto_depIdxs = []int32{
	...
	11, // 18: pluginv2.SubscribeStreamRequest.query:type_name -> pluginv2.DataQuery
	...
	11, // 23: pluginv2.RunStreamRequest.query:type_name -> pluginv2.DataQuery
