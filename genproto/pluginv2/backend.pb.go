...
type StreamPacket struct {
	...
	Payload []byte `protobuf:"bytes,1,opt,name=payload,proto3" json:"payload,omitempty"` // does the server need to parse this payload?
	// ??? perhaps when schema changes set a flag ????
...
func (x *StreamPacket) GetSchema() []byte {
	if x != nil {
		return x.Schema
	}
	return nil
...
var file_backend_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x61, 0x22, 0x6d, 0x0a, 0x18, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65,
	0x54, 0x6f, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	...
	0x74, 0x68, 0x22, 0x45, 0x0a, 0x19, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x54,
	...
	0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x65, 0x0a, 0x10, 0x52, 0x75, 0x6e,
	...
	0x22, 0x40, 0x0a, 0x0c, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74,
	0x12, 0x18, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0c, 0x52, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x63,
	0x68, 0x65, 0x6d, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x06, 0x73, 0x63, 0x68, 0x65,
	0x6d, 0x61, 0x22, 0x56, 0x0a, 0x15, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x4d, 0x65, 0x74,
	...
	0x02, 0x32, 0x5b, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x4f, 0x0a,
	...
	0x44, 0x61, 0x74, 0x61, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xac, 0x01, 0x0a,
	0x06, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x12, 0x5f, 0x0a, 0x14, 0x43, 0x61, 0x6e, 0x53, 0x75,
	0x62, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x54, 0x6f, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x12,
	0x22, 0x2e, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x76, 0x32, 0x2e, 0x53, 0x75, 0x62, 0x73, 0x63,
	0x72, 0x69, 0x62, 0x65, 0x54, 0x6f, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x23, 0x2e, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x76, 0x32, 0x2e, 0x53,
	...
	0x65, 0x61, 0x6d, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x30, 0x01, 0x32, 0xae, 0x01, 0x0a, 0x0b,
	...
	0x2e, 0x3b, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x76, 0x32, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_backend_proto_goTypes = []interface{}{
	...
	(*SubscribeToStreamRequest)(nil),       // 13: pluginv2.SubscribeToStreamRequest
	(*SubscribeToStreamResponse)(nil),      // 14: pluginv2.SubscribeToStreamResponse
	(*RunStreamRequest)(nil),               // 15: pluginv2.RunStreamRequest
	(*StreamPacket)(nil),                   // 16: pluginv2.StreamPacket
	...
	nil,                                    // 21: pluginv2.AppInstanceSettings.DecryptedSecureJsonDataEntry
	nil,                                    // 22: pluginv2.DataSourceInstanceSettings.DecryptedSecureJsonDataEntry
	nil,                                    // 23: pluginv2.CallResourceRequest.HeadersEntry
	nil,                                    // 24: pluginv2.CallResourceResponse.HeadersEntry
	nil,                                    // 25: pluginv2.QueryDataRequest.HeadersEntry
	nil,                                    // 26: pluginv2.QueryDataResponse.ResponsesEntry
	(*CollectMetricsResponse_Payload)(nil), // 27: pluginv2.CollectMetricsResponse.Payload
}
var file_backend_proto_depIdxs = []int32{
	21, // 0: pluginv2.AppInstanceSettings.decryptedSecureJsonData:type_name -> pluginv2.AppInstanceSettings.DecryptedSecureJsonDataEntry
	22, // 1: pluginv2.DataSourceInstanceSettings.decryptedSecureJsonData:type_name -> pluginv2.DataSourceInstanceSettings.DecryptedSecureJsonDataEntry
	...
	23, // 6: pluginv2.CallResourceRequest.headers:type_name -> pluginv2.CallResourceRequest.HeadersEntry
	24, // 7: pluginv2.CallResourceResponse.headers:type_name -> pluginv2.CallResourceResponse.HeadersEntry
	...
	25, // 10: pluginv2.QueryDataRequest.headers:type_name -> pluginv2.QueryDataRequest.HeadersEntry
	9,  // 11: pluginv2.QueryDataRequest.queries:type_name -> pluginv2.DataQuery
	26, // 12: pluginv2.QueryDataResponse.responses:type_name -> pluginv2.QueryDataResponse.ResponsesEntry
	4,  // 13: pluginv2.SubscribeToStreamRequest.pluginContext:type_name -> pluginv2.PluginContext
	4,  // 14: pluginv2.RunStreamRequest.pluginContext:type_name -> pluginv2.PluginContext
	4,  // 15: pluginv2.CollectMetricsRequest.pluginContext:type_name -> pluginv2.PluginContext
	27, // 16: pluginv2.CollectMetricsResponse.metrics:type_name -> pluginv2.CollectMetricsResponse.Payload
	4,  // 17: pluginv2.CheckHealthRequest.pluginContext:type_name -> pluginv2.PluginContext
	0,  // 18: pluginv2.CheckHealthResponse.status:type_name -> pluginv2.CheckHealthResponse.HealthStatus
	5,  // 19: pluginv2.CallResourceRequest.HeadersEntry.value:type_name -> pluginv2.StringList
	5,  // 20: pluginv2.CallResourceResponse.HeadersEntry.value:type_name -> pluginv2.StringList
	12, // 21: pluginv2.QueryDataResponse.ResponsesEntry.value:type_name -> pluginv2.DataResponse
	6,  // 22: pluginv2.Resource.CallResource:input_type -> pluginv2.CallResourceRequest
	10, // 23: pluginv2.Data.QueryData:input_type -> pluginv2.QueryDataRequest
	13, // 24: pluginv2.Stream.CanSubscribeToStream:input_type -> pluginv2.SubscribeToStreamRequest
	15, // 25: pluginv2.Stream.RunStream:input_type -> pluginv2.RunStreamRequest
	19, // 26: pluginv2.Diagnostics.CheckHealth:input_type -> pluginv2.CheckHealthRequest
	17, // 27: pluginv2.Diagnostics.CollectMetrics:input_type -> pluginv2.CollectMetricsRequest
	7,  // 28: pluginv2.Resource.CallResource:output_type -> pluginv2.CallResourceResponse
	11, // 29: pluginv2.Data.QueryData:output_type -> pluginv2.QueryDataResponse
	14, // 30: pluginv2.Stream.CanSubscribeToStream:output_type -> pluginv2.SubscribeToStreamResponse
	16, // 31: pluginv2.Stream.RunStream:output_type -> pluginv2.StreamPacket
	20, // 32: pluginv2.Diagnostics.CheckHealth:output_type -> pluginv2.CheckHealthResponse
	18, // 33: pluginv2.Diagnostics.CollectMetrics:output_type -> pluginv2.CollectMetricsResponse
