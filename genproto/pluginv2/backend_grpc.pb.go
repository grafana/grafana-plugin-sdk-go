...
type DiagnosticsClient interface {
	...
	CollectUsageStats(ctx context.Context, in *CollectUsageStatsRequest, opts ...grpc.CallOption) (*CollectUsageStatsResponse, error)
}
...
func (c *diagnosticsClient) CollectUsageStats(ctx context.Context, in *CollectUsageStatsRequest, opts ...grpc.CallOption) (*CollectUsageStatsResponse, error) {
	out := new(CollectUsageStatsResponse)
	err := c.cc.Invoke(ctx, "/pluginv2.Diagnostics/CollectUsageStats", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DiagnosticsServer interface {
	...
	CollectUsageStats(context.Context, *CollectUsageStatsRequest) (*CollectUsageStatsResponse, error)
}
...
func (UnimplementedDiagnosticsServer) CollectUsageStats(context.Context, *CollectUsageStatsRequest) (*CollectUsageStatsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CollectUsageStats not implemented")
}
...
func _Diagnostics_CollectUsageStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CollectUsageStatsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DiagnosticsServer).CollectUsageStats(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pluginv2.Diagnostics/CollectUsageStats",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DiagnosticsServer).CollectUsageStats(ctx, req.(*CollectUsageStatsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Diagnostics_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CollectUsageStats",
			Handler:    _Diagnostics_CollectUsageStats_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "backend.proto",
