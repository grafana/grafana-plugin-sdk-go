...
const (
	Metadata_ProvideMetadata_FullMethodName = "/pluginv2.Metadata/ProvideMetadata"
)
...
type MetadataClient interface {
	// ProvideMetadata is called by Grafana to get metadata belonging to the datasource instance.
	// This is in the form of collections of text which can be queried by natural language models
	// to aid the user in writing queries.
	ProvideMetadata(ctx context.Context, in *ProvideMetadataRequest, opts ...grpc.CallOption) (*ProvideMetadataResponse, error)
}
...
func (c *metadataClient) ProvideMetadata(ctx context.Context, in *ProvideMetadataRequest, opts ...grpc.CallOption) (*ProvideMetadataResponse, error) {
	out := new(ProvideMetadataResponse)
	err := c.cc.Invoke(ctx, Metadata_ProvideMetadata_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MetadataServer interface {
	...
	// This is in the form of collections of text which can be queried by natural language models
	// to aid the user in writing queries.
	ProvideMetadata(context.Context, *ProvideMetadataRequest) (*ProvideMetadataResponse, error)
}
...
func (UnimplementedMetadataServer) ProvideMetadata(context.Context, *ProvideMetadataRequest) (*ProvideMetadataResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ProvideMetadata not implemented")
}
...
func _Metadata_ProvideMetadata_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ProvideMetadataRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MetadataServer).ProvideMetadata(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Metadata_ProvideMetadata_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MetadataServer).ProvideMetadata(ctx, req.(*ProvideMetadataRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Metadata_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pluginv2.Metadata",
	HandlerType: (*MetadataServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "ProvideMetadata",
			Handler:    _Metadata_ProvideMetadata_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "backend.proto",
