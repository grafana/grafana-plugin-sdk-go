...
lint: $(GOPATH)/bin/golangci-lint $(GOPATH)/bin/revive $(GOPATH)/bin/gosec
	...
	$(GOPATH)/bin/revive -exclude ./vendor/... -formatter stylish -config scripts/go/configs/revive.toml ./...
	$(GOPATH)/bin/gosec -quiet -exclude=G104,G107,G108,G201,G202,G204,G301,G304,G401,G402,G501 -conf=scripts/go/configs/gosec.json ./...
