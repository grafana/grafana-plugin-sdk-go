...
func (a *sdkAdapter) CheckPluginHealth(ctx context.Context, protoReq *pluginv2.CheckPluginHealthRequest) (*pluginv2.CheckHealthResponse, error) {
...
func (a *sdkAdapter) CheckDatasourceHealth(ctx context.Context, protoReq *pluginv2.CheckDatasourceHealthRequest) (*pluginv2.CheckHealthResponse, error) {
	if a.CheckHealthHandler != nil {
