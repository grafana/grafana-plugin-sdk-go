...
const (
	InstanceSettingsOperation_CREATE InstanceSettingsOperation = 0
	InstanceSettingsOperation_UPDATE InstanceSettingsOperation = 1
	InstanceSettingsOperation_DELETE InstanceSettingsOperation = 2
)
