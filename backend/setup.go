...
const (
	...
	// Deprecated: Use buildinfo.GetBuildInfo().Version instead.
...
func getTracingConfig(buildInfoGetter buildinfo.InfoGetter) tracingConfig {
...
func remoteSamplerServiceName(buildInfoGetter buildinfo.InfoGetter) string {
