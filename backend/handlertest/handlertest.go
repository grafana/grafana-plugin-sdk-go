...
func (h Handler) ConvertObject(ctx context.Context, req *backend.ConversionRequest) (*backend.ConversionResponse, error) {
	if h.ConvertObjectFunc != nil {
		return h.ConvertObjectFunc(ctx, req)
	}
...
func NewHandlerMiddlewareTest(t *testing.T, opts ...HandlerMiddlewareTestOption) *HandlerMiddlewareTest {
	...
	cdt.TestHandler = &Handler{
		...
		ConvertObjectFunc: func(ctx context.Context, cr *backend.ConversionRequest) (*backend.ConversionResponse, error) {
