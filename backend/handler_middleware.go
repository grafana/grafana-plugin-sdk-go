...
func (h *MiddlewareHandler) setupContext(ctx context.Context, pluginCtx PluginContext, endpoint ctxHelpers.Endpoint) context.Context {
	ctx = initErrorSource(ctx)
	ctx = ctxHelpers.WithEndpoint(ctx, endpoint)
