	...
	return []datasource.QueryResult{
		{
			...
			DataFrames: []*dataframe.Frame{
				dataframe.New("http_requests_total", dataframe.Labels{"service": "auth", "env": "prod"},
					...
					dataframe.NewField("value", []float64{45.0, 49.0, 29.0}),
				),
				dataframe.New("go_goroutines", dataframe.Labels{},
					dataframe.NewField("timestamp", []int64{123238426, 123238456, 123238486}),
					dataframe.NewField("value", []float64{45.0, 49.0, 29.0}),
				),
			},
		},
		{
			...
			DataFrames: []*dataframe.Frame{
				dataframe.New("organization", dataframe.Labels{"component": "business"},
					dataframe.NewField("department", []string{"engineering", "sales"}),
					dataframe.NewField("num_employees", []int64{20, 15}),
				),
			},
		},
	}, nil
