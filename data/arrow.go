...
func initializeFrameField(field arrow.Field, idx int, nullable []bool, sdkField *Field) error {
	...
	case arrow.STRING:
		if nullable[idx] {
			sdkField.vector = newVector[*string](0)
			break
		}
		sdkField.vector = newVector[string](0)
	case arrow.INT8:
		if nullable[idx] {
			sdkField.vector = newVector[*int8](0)
			break
		}
		sdkField.vector = newVector[int8](0)
	case arrow.INT16:
		if nullable[idx] {
			sdkField.vector = newVector[*int16](0)
			break
		}
		sdkField.vector = newVector[int16](0)
	case arrow.INT32:
		if nullable[idx] {
			sdkField.vector = newVector[*int32](0)
			break
		}
		sdkField.vector = newVector[int32](0)
	case arrow.INT64:
		if nullable[idx] {
			sdkField.vector = newVector[*int64](0)
			break
		}
		sdkField.vector = newVector[int64](0)
	case arrow.UINT8:
		if nullable[idx] {
			sdkField.vector = newVector[*uint8](0)
			break
		}
		sdkField.vector = newVector[uint8](0)
	case arrow.UINT16:
		if nullable[idx] {
			sdkField.vector = newVector[*uint16](0)
			break
		}
		sdkField.vector = newVector[uint16](0)
	case arrow.UINT32:
		if nullable[idx] {
			sdkField.vector = newVector[*uint32](0)
			break
		}
		sdkField.vector = newVector[uint32](0)
	case arrow.UINT64:
		if nullable[idx] {
			sdkField.vector = newVector[*uint64](0)
			break
		}
		sdkField.vector = newVector[uint64](0)
	case arrow.FLOAT32:
		if nullable[idx] {
			sdkField.vector = newVector[*float32](0)
			break
		}
		sdkField.vector = newVector[float32](0)
	case arrow.FLOAT64:
		if nullable[idx] {
			sdkField.vector = newVector[*float64](0)
			break
		}
		sdkField.vector = newVector[float64](0)
	case arrow.BOOL:
		if nullable[idx] {
			sdkField.vector = newVector[*bool](0)
			break
		}
		sdkField.vector = newVector[bool](0)
	case arrow.TIMESTAMP:
		if nullable[idx] {
			sdkField.vector = newVector[*time.Time](0)
			break
		}
		sdkField.vector = newVector[time.Time](0)
	case arrow.BINARY:
		if nullable[idx] {
			sdkField.vector = newVector[*json.RawMessage](0)
			break
		}
		sdkField.vector = newVector[json.RawMessage](0)
	default:
